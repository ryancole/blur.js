...
(function($) {
    ...
    // append this function to jquery
    $.fn.blurjs = function (options) {
        ...
        // extend option defaults
        options = $.extend(option_defaults, options);
        ...
        return this.each(function (index) {
            ...
            var source_item = options.source;
            
            // handle an array of source items
            if (Array.isArray(source_item)) {
                
                // default to first item if we matched more elements than were given sources for
                if (index < source_item.length)
                    source_item = source_item[index];
                else
                    source_item = source_item[0];
                    
            }
            
            // store the elements for this iteration
            var $glue = $(this),
                $source = $(source_item),
